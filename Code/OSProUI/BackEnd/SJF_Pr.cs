    ...
    class SJF_Pr : schedAlgo
    {
        ...
        public override void schedule()
        {
            ...
            do
            {
                ...
                waitingProcessList = waitingProcessList.OrderBy(i => i.burstTime).ToList();
                ...
                else if (waitingProcessList.Count != 0 && (waitingProcessList[0].burstTime < currentProcessList[0].burstTime))
                {
                ...
                if (currentProcessList.Count != 0)
                {
                    ...
                    //if(currentProcessList[0].arrivalTime != currentProcessList[0].startTime && waitingProcessList.Count!=0)
